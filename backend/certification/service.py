...
async def grade_attempt(
    ...
    if passed and not is_practical:
        ...
        await wallet_credit(
            ...
            # RECONCILE-2 Groupe 3/5: r35l31 named this kwarg
            # economic_event_id; wallet.credit()'s resolved, mandatory
            # idempotency parameter is effect_key (main's naming, kept
            # canonical — see wallet/service.py). Same value, same
            # "certification-pass:{attempt_id}" convention Groupe 3
            # already proved closes this exact double-credit gap.
