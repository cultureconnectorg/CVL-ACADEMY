...
OFFER_CATALOG: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "status": "DECIDED_V1",
        "monthly_eur": 129,
        "annual_or_unit_eur": 1290,
        "billing": "subscription",
        "decision_id": "ECO-006",
    },
    {
        "id": "CAREER_PATH",
        "name": "Parcours métier",
        "channel": "B2C/B2B",
        "commercialization": "public",
        "status": "DECIDED_V1",
        "monthly_eur": 0,
        "annual_or_unit_eur": 990,
        "billing": "one_time",
        "decision_id": "ECO-007",
    },
    {
        "id": "INTENSIVE_HYBRID_WEEK",
        "name": "Intensive Hybrid Week",
        "channel": "B2C/B2B/B2G",
        "commercialization": "cohort",
        "status": "DECIDED_V1",
        "monthly_eur": 0,
        "annual_or_unit_eur": 1400,
        "billing": "per_learner",
        "decision_id": "ECO-008",
    },
    {
        ...
        "status": "DECIDED_V1",
        "monthly_eur": 0,
        "annual_or_unit_eur": 250,
        "billing": "one_time",
        "decision_id": "ECO-009",
    },
    {
        "id": "CERTIFICATION_ACADEMY",
        "name": "Certification Academy",
        "channel": "Certification",
        "commercialization": "public",
        "status": "DECIDED_V1",
        "monthly_eur": 0,
        "annual_or_unit_eur": 390,
        "billing": "one_time",
        "decision_id": "ECO-010",
    },
    {
    ...
    },
    {
        ...
        "commercialization": "contract",
        "status": "DECIDED_V1",
        "annual_or_unit_eur": 250000,
        "billing": "program",
        "capacity": 250,
        "decision_id": "ECO-017",
    },
    {
        "id": "LEARNING_TO_WORK_CLIENT",
        "name": "Learning-to-Work",
        "channel": "Mission",
        "commercialization": "contract",
        "status": "DECIDED_V1",
        "annual_or_unit_eur": 150,
        "billing": "12_percent_gmv_minimum",
        "gmv_rate": 0.12,
        "minimum_eur": 150,
        "candidate_fee_eur": 0,
        "decision_id": "ECO-019",
    ...
    {
        "id": "METHODOLOGY_IP_LICENCE",
        "name": "Methodology/IP Licence",
        "channel": "Platform/IP",
        "commercialization": "b2b_b2g",
        "status": "DECIDED_PHASE_2",
        "annual_or_unit_eur": 25000,
        "billing": "annual_contract",
        "decision_id": "ECO-021",
    },
    {
        "id": "ACADEMY_SPATIAL_LICENCE",
        "name": "Academy+Spatial Licence",
        "channel": "Platform/IP",
        "commercialization": "b2b_b2g",
        "status": "DECIDED_PHASE_3",
        "annual_or_unit_eur": 60000,
        "billing": "annual_contract",
        "decision_id": "ECO-022",
    },
    {
        ...
        "annual_or_unit_eur": 120000,
        "setup_eur": 25000,
        "billing": "annual_contract_plus_setup",
        "decision_id": "ECO-023",
    },
]
...
PUBLIC_OFFER_IDS = {
    ...
    "ACADEMY_CAREER",
    "CAREER_PATH",
    "INTENSIVE_HYBRID_WEEK",
    "ASSESSMENT_ONLY",
    "CERTIFICATION_ACADEMY",
    "CERTIFICATION_RENEWAL",
}
MARKET_ELIGIBLE_OFFERS = [
    "ACADEMY_PRO",
    "CAREER_PATH",
    "INTENSIVE_HYBRID_WEEK",
    "B2B_TEAM",
...
def formation_commercialization(formation: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if "EXTERNAL" in contexts:
        return {
            **base,
            "commercial_class": "PUBLIC_MARKET_UNMAPPED",
            "public": "OUI",
            "packaging": "OFFER_BASED_NOT_FORMATION_PRICE",
            "price_policy": "subscription / €990 path / cohort / contract",
            "eligible_offer_ids": MARKET_ELIGIBLE_OFFERS,
        }
    if "BRIDGE" in contexts:
        return {
            **base,
            "commercial_class": "BUNDLED_BRIDGE_UNMAPPED",
            "public": "SÉLECTIF",
            "packaging": "BUNDLED_BRIDGE",
            "price_policy": "Pas vendu seul",
            "eligible_offer_ids": BRIDGE_OFFERS,
        }
    return {
        **base,
        "commercial_class": "INTERNAL_NOT_FOR_SALE_UNMAPPED",
        "public": "NON",
        "packaging": "INTERNAL",
        "price_policy": "NOT_FOR_SALE",
    }
