    ...
    return [
        {
            ...
            "choices": [
                {
                    "id": "A",
                    "text": f"Produire le livrable : {deliverable}",
                    "correct": True,
                },
                {
                    "id": "B",
                    "text": "Regarder une démonstration sans participer",
                    "correct": False,
                },
                {
                    "id": "C",
                    "text": "Obtenir le badge sans validation",
                    "correct": False,
                },
                {
                    "id": "D",
                    "text": "Accumuler des heures sans livrable",
                    "correct": False,
                },
            ],
        },
        {
            ...
            "choices": [
                {
                    "id": "A",
                    "text": "Une situation caribéenne réelle qui illustre l'enjeu",
                    "correct": True,
                },
                {
                    "id": "B",
                    "text": "Une situation fictive inventée pour l'exercice",
                    "correct": False,
                },
                {
                    "id": "C",
                    "text": "Un exemple de succès sans contexte",
                    "correct": False,
                },
        ...
        },
        {
            ...
            "choices": [
                {
                    "id": "VRAI",
                    "text": f"Vrai — chaque livrable génère un signal {signal}",
                    "correct": True,
                },
                {
                    "id": "FAUX",
                    "text": "Faux — le livrable est optionnel",
                    "correct": False,
                },
            ],
        },
        {
            ...
            "choices": [
                ...
                {
                    "id": "C",
                    "text": "80% — seuil standard CVLN Academy",
                    "correct": True,
                },
        ...
        },
        {
            ...
            "choices": [
                {
                    "id": "A",
                    "text": f"{signal} — généré à la remise du livrable",
                    "correct": True,
                },
                {
                    "id": "B",
                    "text": "FREK-TIME uniquement — les vidéos regardées",
                    "correct": False,
                },
                {
                    "id": "C",
                    "text": "Aucun signal — FREK est optionnel",
                    "correct": False,
                },
        ...
        },
        {
            ...
            "choices": [
                {
                    "id": "A",
                    "text": f"Le stade détermine la complexité et l'autonomie — {stade_label}",
                    "correct": True,
                },
                {
                    "id": "B",
                    "text": "Le stade est indicatif et peut être ignoré",
                    "correct": False,
                },
                {
                    "id": "C",
                    "text": "Tous les stades ont la même difficulté",
                    "correct": False,
                },
                {
                    "id": "D",
                    "text": "Le stade ne concerne que les formateurs",
                    "correct": False,
                },
            ],
        },
        {
            ...
            "choices": [
                {
                    "id": "A",
                    "text": "Archivé dans FREK, génère des CC et alimente le FREK-ID",
                    "correct": True,
                },
                {
                    "id": "B",
                    "text": "Gardé localement sans intégration",
                    "correct": False,
                },
                {"id": "C", "text": "Envoyé par email uniquement", "correct": False},
                {
                    "id": "D",
                    "text": "Aucune intégration — la formation est indépendante",
                    "correct": False,
                },
            ],
        },
