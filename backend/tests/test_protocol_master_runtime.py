...
def test_protocol_master_is_exactly_227_rows_3_through_229():
...
def test_every_excel_line_has_runtime_handler_and_source_identity():
    for control in load_protocol_controls():
        ...
        assert len(control["source"]["workbook_sha256"]) == 64
