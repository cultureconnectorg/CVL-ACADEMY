...
| `BLOCKED` | GMD-34 (product gap); Kiltikonet KLT-09→20 (governance gate); FRK-16/19/21/22/24/39/57/64/65/66/67 (11, `docs/frk/*/GAP.md`); AF-18/19/20/21/23/25/24, AF-X-01/02/04/05/06/07/08/09, IOS-01→06/08→25 (39, `docs/agf/BLOCKED_CANDIDATES.md`); 60 rows across CYB/BCI/GCF/LOS (`docs/cyb/`, `docs/bci/`, `docs/gcf/`, `docs/los/` `BLOCKED_CANDIDATES.md` each) |
| `RECONCILED_NOT_BUILT` | Good Mood/DJ Sayd external-market rows (~51); WAL-01→18 + WAL-X (27); Founder/CEO+Group+Fondation (158); Cross-CVLN XCV-01→56 (~57) |
