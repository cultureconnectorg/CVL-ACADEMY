...
| KOR-13→15 (KORA professions) | 3 | `docs/kor/kor13→15/` | `DRAFTED` — each `REFERENTIAL.md` self-declares `STATUS = PROPOSED`; lightest of the KOR corpus (887–1,021 lines); same compact template as KOR-11/12 before their rebuild, not yet touched |
...
| `DRAFTED` | KOR-13→15 (3); FRK (47 — see `docs/frk/README.md`) |
