...
| `PARTIAL_PACKAGE` | KOR-03→10 (8), KLT-06→08 (3); FMS-07→18 (9, 1/9 `PACKAGE_COMPLETE`, 8/9 `DRAFTED`); FREK (75, 8/75 `PACKAGE_COMPLETE`, 47/75 `DRAFTED`, 11/75 `BLOCKED`, 8/75 `EXTEND_EXISTING`); Agent Factory cluster (109, 1/109 `PACKAGE_COMPLETE`, 58/109 `DRAFTED`, 39/109 `BLOCKED`, 11/109 `EXTEND_EXISTING`) |
