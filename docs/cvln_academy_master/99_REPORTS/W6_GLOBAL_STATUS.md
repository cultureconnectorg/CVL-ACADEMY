...
| KOR-12→15 (KORA professions) | 4 | `docs/kor/kor12→15/` | `DRAFTED` — each `REFERENTIAL.md` self-declares `STATUS = PROPOSED`; lightest of the KOR corpus (887–1,021 lines); same compact template as KOR-11 before its rebuild, not yet touched |
...
| `DRAFTED` | KOR-12→15 (4); FRK (47 — see `docs/frk/README.md`) |
