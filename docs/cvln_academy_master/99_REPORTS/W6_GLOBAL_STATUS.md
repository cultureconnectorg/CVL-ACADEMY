...
|---|---|
| `PACKAGE_COMPLETE` | KOR-01/02, KLT-01→05, FMS-01→06 (pre-existing canon); GMD-21→33 (13/13); WAL-19; CVE-02; FMS-07; FRK-01; CMD-15 |
| `PARTIAL_PACKAGE` | KOR-03→10 (8), KLT-06→08 (3); FMS-07→18 (9, 1/9 `PACKAGE_COMPLETE`, 8/9 `DRAFTED`); FREK (75, 1/75 `PACKAGE_COMPLETE`, 55/75 `DRAFTED`, 11/75 `BLOCKED`, 8/75 `EXTEND_EXISTING`); Agent Factory cluster (109, 1/109 `PACKAGE_COMPLETE`, 58/109 `DRAFTED`, 39/109 `BLOCKED`, 11/109 `EXTEND_EXISTING`) |
| `DRAFTED` | KOR-11→15 (5); WAL-20/21/22/23/24/25/26/27/28 (9); CVE-01,03→15 (14); FMS-08/09/10/11/12/13/15/18 (8); FRK (55 — see `docs/frk/README.md`); AGF (58 — see `docs/agf/README.md`) |
