...
| KOR-15 (KORA professions) | 1 | `docs/kor/kor15/` | `DRAFTED` — `REFERENTIAL.md` self-declares `STATUS = PROPOSED`; same compact template as KOR-11→14 before their rebuild, not yet touched |
