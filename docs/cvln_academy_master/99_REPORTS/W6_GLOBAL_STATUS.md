...
|---|---|
| `PACKAGE_COMPLETE` | KOR-01/02, KLT-01→05, FMS-01→06 (pre-existing canon); GMD-21→33 (13/13); WAL-19; CVE-02; FMS-07; FRK-01/03/06/13/56/58/59/68 (8); CMD-15, AF-16/17/AF-X-03/BRN-15/IOS-07 + af01_03/af04_15/lau01_10/brn01_14/cmd01_14 (11 AGF formations, 59 rows) |
| `PARTIAL_PACKAGE` | KOR-03→10 (8), KLT-06→08 (3); FMS-07→18 (9, 1/9 `PACKAGE_COMPLETE`, 8/9 `DRAFTED`); FREK (75, 54/75 `PACKAGE_COMPLETE`, 3/75 `DRAFTED` (`NEEDS_EXPERT_REVIEW`), 10/75 `BLOCKED`, 8/75 `EXTEND_EXISTING`); Agent Factory cluster (109, 59/109 `PACKAGE_COMPLETE`, 39/109 `BLOCKED`, 11/109 `EXTEND_EXISTING`); KORA interne/cross (19, 1/19 `PACKAGE_COMPLETE`, 18/19 `EXTEND_EXISTING`/converged-index) |
...
| `RECONCILED_NOT_BUILT` | Good Mood/DJ Sayd external-market rows (~51); WAL-01→18 + WAL-X (27); CyberSecure+Blockchain+Gala+Hospitality+LabelOS (214); Founder/CEO+Group+Fondation (158); Cross-CVLN XCV-01→56 (~57) |
