...
| KOR-14→15 (KORA professions) | 2 | `docs/kor/kor14→15/` | `DRAFTED` — each `REFERENTIAL.md` self-declares `STATUS = PROPOSED`; lightest of the KOR corpus (887–1,021 lines); same compact template as KOR-11→13 before their rebuild, not yet touched |
...
| `DRAFTED` | KOR-14→15 (2); FRK (47 — see `docs/frk/README.md`) |
