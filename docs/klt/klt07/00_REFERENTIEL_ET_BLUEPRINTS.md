...
connectée (accès Network réel), pas seulement rédigée. Ne jamais
déclarer KLT-07 complet tant que ce champ n'a pas été explicitement
repassé à TRUE par un ticket dédié.
