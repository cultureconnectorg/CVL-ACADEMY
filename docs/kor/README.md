...
| `KOR-14`→`15` | 2 derniers angles métier KORA | variable | 100% par formation | `BUILT`, `DRAFTED` (chaque `REFERENTIAL.md` self-déclare `STATUS = PROPOSED` pour au moins un scénario de cas ; même gabarit compact que `KOR-11`→`13` avant leur reconstruction, non encore engagé) |
