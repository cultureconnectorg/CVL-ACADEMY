...
const CONTENT_ASSERTIONS = {
  ...
  "GOV-014": () => assert.match(read("docs/SPATIAL_LEARNING_W0_AUDIT.md"), /PlayStation|Sony/i),
  ...
  "PRD-009": () => assert.match(read("frontend/src/pages/Roadmap.js"), /<Horizon[\s\S]*future/),
